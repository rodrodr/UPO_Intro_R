---
title: "\\<b>Tutorial 2\\</b>\\<br>Picando datos"
...
```{r 04_df1, exercise=TRUE, exercise.lines=4}
...
```{r 04_df4b, exercise=TRUE, exercise.lines=4}
...
```{r 03_open_sav, exercise=TRUE, warning=F}
...
```{r 04_df5a, exercise=TRUE, exercise.lines=3}
...
```{r 04_df5b, exercise=TRUE, exercise.lines=3}
...
```{r 04_df5c, exercise=TRUE, exercise.lines=5}
...
```{r 04_df5d, exercise=TRUE, exercise.lines=5}
...
```{r 04_df5e, exercise=TRUE, exercise.lines=3}
...
w[w$muslim=="Yes", c("country", "dem_level4", "religoin")]
...
```{r 04_df5i, exercise=TRUE, exercise.lines=3}
...
## **Pista:** Tendrás que probablemente 
## combinar el operador lógico NOT: '!', 
## con la función 'is.na(w$gini10)' 
## para seleccionar LÍNEAS en el data.frame *w*.

```

```{r 04_df5i-hint-2}

## **Pista:** Recuerda, las LÍNEAS se seleccionan 
## ANTES de las comas dentro de los corchetes: x[LINEAS,]. 
## Por lo tanto, tu condición lógica debe ir 
## ANTES de la coma.
...
```{r 04_df6b, exercise=TRUE, exercise.lines=4}
...
```{r 04_df6c, exercise=TRUE, exercise.lines=10}
...
```{r 04_df6d, exercise=TRUE, exercise.lines=10}
...
```{r 04_df6e, exercise=TRUE, exercise.lines=6}
...
```{r 01_ind, exercise=TRUE, exercise.lines=10}
...
```{r 02_ind, exercise=TRUE, exercise.lines=17}
...
```{r 03_ind, exercise=TRUE, exercise.lines=26}
...
```{r 04_ind, exercise=TRUE, exercise.lines=22}
...
```{r 04_indb, exercise=TRUE, exercise.lines=17}
...
```{r 05_ind, exercise=TRUE, exercise.lines=15}
