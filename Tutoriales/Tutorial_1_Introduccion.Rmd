---
title: "\\<b>Tutorial 1\\</b>\\<br>Introducción al R"
...
![](https://www.youtube.com/watch?v=3hR2A2nCI4U)
...
1. Comentarios de línea completa:
    ...
    <span style="color:green">\# El siguiente comando calcula la media de la variable a.</span>
...
2. Comentarios en línea:
    ...
    mean(a) <span style="color:green">\# este comando calcula la media de la variable a</span>
