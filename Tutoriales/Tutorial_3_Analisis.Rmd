---
title: "\\<b>Tutorial 3\\</b>\\<br>Análisis"
...
![](https://www.youtube.com/watch?v=j7i58t5a5BU)
...
![](https://www.youtube.com/watch?v=TPcAnExkWwQ)
...
![](https://www.youtube.com/watch?v=GtV-VYdNt_g&list=PL8dPuuaLjXtNM_Y-bUAhblSAdWRnmBUcr&index=10)
...
```{r 01_quizA}
quiz(caption = "¿Que te parece?",
    question("Después de analizar el valor p, puedes decir que (recuerda usar el nivel de significancia de 0.05):",
      answer("H0 es verdadera, por lo que no hay una diferencia significativa.", message = "El valor p es menor que 0.05, lo que significa que hay suficiente evidencia para RECHAZAR la hipótesis nula en favor de la hipótesis alternativa. Por lo tanto, podemos concluir que hay una diferencia significativa en la tasa de abortos entre los estados donde Obama y McCain ganaron en 2008."),
      answer("H1 es verdadera, por lo que los estados donde Obama ganó tienen una tasa de abortos mayor que los estados donde McCain ganó.", correct = TRUE),
      answer("La evidencia no es suficiente para rechazar la hipótesis nula.", message = "Hay suficiente evidencia para rechazar la hipótesis nula en favor de la hipótesis alternativa. El valor p or la probabilidad de aceptar H0 como verdadera es realmente baja (menos de uno en un millón)."),
      allow_retry = T
  ))
```
...
```{r 01_chi_quiz}
quiz(caption = "¿Qué te parece?",
    question("Después de analuzar el valor p, puedes decir que (recuerda usar el nivel de significancia de 0.05):",
      answer("El valor p o la probabilidad de aceptar H0 como verdadera es realmente baja (uno en diez mil). Por lo tanto, aceptamos que hay una relación de significancia estadística entre las restricciones al aborto y la religiosidad."),
      answer("H1 es verdadero, por lo que hay una asociación estadística entre las restricciones al aborto y la religiosidad.", correct = TRUE),
      answer("La evidencia no resulta suficiente para distinguir entre las dos.", message = "Hay suficiente evidencia para rechazar la hipótesis nula en favor de la hipótesis alternativa. El valor p o la probabilidad de aceptar H0 como verdadera es realmente baja (uno en diez mil). Por lo tanto, aceptamos que hay una relación de significancia estadística entre las restricciones al aborto y la religiosidad."),
      allow_retry = T
  ))
```
...
quiz(caption = "¿Qué te parece?",
    question("Después de analizar el valor p, puedes decir que (recuerda usar el nivel de significancia de 0.05):",
      answer("H0 es verdadera, así que no existe diferencia significativa.", message = "El valor p o la probabilidad de aceptar H0 como verdadera es realmente baja (uno en un millón). Por lo tanto, aceptamos que hay una relación de significancia estadística entre el PIB per cápita y el tipo de régimen."),
      answer("H1 es verdadera, así que existe una asociación estadística entre PIB per cápita y tipo de régimen.", correct = TRUE),
      answer("Las evidencias no son suficientes para distinguir entre los diferentes tipos de régimen.", message = "No hay suficiente evidencia para rechazar la hipótesis nula en favor de la hipótesis alternativa. El valor p o la probabilidad de aceptar H0 como verdadera es realmente baja (uno en un millón). Por lo tanto, aceptamos que hay una relación de significancia estadística entre el PIB per cápita y el tipo de régimen."),
      allow_retry = T
  ))
```
...
quiz(caption = "",
    question("Después de analizar el valor p, puedes decir que (recuerda usar el nivel de significancia de 0.05):",
      answer("H0 es verdadero, de modo que no parece haver diferencia significativa entre el nivel PROMEDIO de democracia entre países musulmanes y de otras mayorías religiosas.", message = "El p-value o la probabilidad de H0 como verdadera es realmente baja (menor que uno en un millón). Por lo tanto, aceptamos que existe una diferencia estadísticamente significativa entre el nivel PROMEDIO de democracia en países musulmanes comparados con los demás. No obstante, eso no significa que todos sean más bajos. Estamos hablando de un promedio."),
      answer("H1 is TRUE, so there is a statistically significant difference in the AVERAGE level of democracy in Muslim compared to other countries.", correct = TRUE),
      answer("La evidencia no resulta suficiente para distinguir entre las dos hipótesis.", message = "El p-value o la probabilidad de H0 como verdadera es realmente baja (menor que uno en un millón). Por lo tanto, aceptamos que existe una diferencia estadísticamente significativa entre el nivel PROMEDIO de democracia en países musulmanes comparados con los demás. No obstante, eso no significa que todos sean más bajos. Estamos hablando de un promedio."),
      allow_retry = T
  ))
```
